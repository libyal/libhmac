...
#if !defined( _LIBHMAC_EXTERN_H )
#define _LIBHMAC_EXTERN_H

/* To export functions from the libhmac DLL define LIBHMAC_DLL_EXPORT
 * To import functions from the libhmac DLL define LIBHMAC_DLL_IMPORT
