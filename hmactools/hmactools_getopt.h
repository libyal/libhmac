...
#if !defined( _HMACTOOLS_GETOPT_H )
#define _HMACTOOLS_GETOPT_H
...
typedef struct hmactools_option hmactools_option_t;

struct hmactools_option
{
...
#define hmactools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t hmactools_getopt(
                  int argument_count,
...
void hmactools_getopt_wrapped_fprint(
      FILE *stream,
...
void hmactools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const hmactools_option_t *options,
      int number_of_options );

int hmactools_getopt_get_options_string(
     const hmactools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _HMACTOOLS_GETOPT_H ) */
