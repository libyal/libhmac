...
void (*hmactools_signal_signal_handler)( hmactools_signal_t ) = NULL;
             ...
             unsigned long signal )
{
	...
	switch( signal )
	{
		...
		case CTRL_C_EVENT:
			if( hmactools_signal_signal_handler != NULL )
			{
...
{
	static char *function = "hmactools_signal_attach";
...
#if defined( _MSC_VER )
	hmactools_signal_initialize_memory_debug();
#endif
     ...
     libcerror_error_t **error )
{
	...
	hmactools_signal_signal_handler = NULL;
